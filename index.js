...
const UUID = process.env.UUID || '9f730301-835c-4f19-af3a-bff7618507bd'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'whb77AzqINa09EnSN8';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const SUB_PATH = process.env.SUB_PATH || 'zyr';            // 获取节点的订阅路径
